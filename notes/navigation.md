...
- [navigation](#navigation)
  ...
  - [multi-page app with sending data from page to page](#multi-page-app-with-sending-data-from-page-to-page)

## introduction

it's important to know how to navigate around an app

## multi-page app with sending data from page to page

please see [../projects/MultiPage05] for a good indication of how to create a multi-page app and also how to send data from page to page.

In particular, when you go to page 5 list view of cards with data, clicking on one card will take, after a pause of 4 seconds, the user to the next page 6 and also display data from the card which was clicked on.
