...
class DateTimePicker01 extends StatefulWidget {
  const DateTimePicker01({Key? key}) : super(key: key);

  @override
  State<DateTimePicker01> createState() => _DateTimePicker01State();
}

class _DateTimePicker01State extends State<DateTimePicker01> {
  ...
  String _valueToValidate2 = '2001-10-21 15:31';
  String _valueSaved2 = '2001-10-21 15:31';
  String _valueChanged3 = '2001-10-21';
  String _valueToValidate3 = '2001-10-21';
  String _valueSaved3 = '2001-10-21';
          ...
          child: Column(
            children: <Widget>[
              ...
              DateTimePicker(
                ...
                validator: (val) {
                  print(
                      'about to set value of calendar 2 ... _valueToValidate2 ' +
                          _valueToValidate2 +
                          ' ... val ... ' +
                          val.toString());
